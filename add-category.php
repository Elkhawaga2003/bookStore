...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <form method="POST" action="php/add-category.php" class="shadow p-4 rounded mt-5"
    style="width: 90%;max-width: 50rem;">
        <h1 class="text-center p-5 display-4 fs-3"> Add category</h1>
        <div class="mb-3">
            <label for ="form-control">add category</label>
        <input type="text" class="form-control" required name="category_name">
        </div>
        <input type="submit" value="add author" class="btn btn-primary" name="submit">
    </form>
</body>
</html>
<?php }else{
